...
//首页推荐主接口
let CJRecommandProvider = MoyaProvider<CJRecommandAPI>()

enum CJRecommandAPI {
    case recommandList //推荐列表
    case recommandForYouList //为你推荐
    case recommandAdList //推荐页面穿插的广告
...
extension CJRecommandAPI: TargetType {
    //服务器地址
    public var baseURL: URL {
        switch self {
        case .recommandAdList:
    ...
    var path: String {
        ...
        case .recommandForYouList:
            return "/mobile/discovery/v4/recommend/albums"
        case .recommandAdList:
            return "/ting/feed/ts-1532656780625"
        case .guessYouLikeMoreList:
            return "/discovery-firstpage/guessYouLike/list/ts-1534815616591"
        case .changeGuessYouLikeList:
            return "/discovery-firstpage/guessYouLike/cycle/ts-1535167862593"
        case .changePaidCategoryList:
            return "/mobile/discovery/v1/guessYouLike/paidCategory/ts-1535167980873"
        case .changeLiveList:
            return "/lamia/v1/hotpage/exchange"
        case .changeOtherCategory(categoryId: _):
            return "/mobile/discovery/v4/albums/ts-1535168024113"
        }
    }
    ...
    var task: Task {
        ...
        case .recommandForYouList:
            parameters = [
                ...
                "deviceId": UIDevice.current.identifierForVendor!.uuidString]
        /*
         http://adse.ximalaya.com/ting/feed/ts-1532656780625?device=iPhone&appid=0&name=find_native&network=WIFI&operator=3&scale=3&version=6.5.3&xt=1534815616592%20HTTP/1.1
         */
        case .recommandAdList:
            parameters = [
                "device":"iPhone",
